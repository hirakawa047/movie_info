...
api_version = "v3"
DEVELOPER_KEY = 'AIzaSyCMi3RXxT9RTLK4JnGfn8hRZiXQZ1MIqXE'
...
'''
with open('/Users/kazuki/source/python/cip_test/youtube_get_videos.py/youtuber.csv',"r",encoding="utf-8") as csv_file:
...
youtube = get_authenticated_service()
test_channel_id = 'UC3H2C4h39zoRc_BybCaXgIA'
